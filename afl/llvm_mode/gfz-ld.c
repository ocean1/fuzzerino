...
int main(int argc, char** argv) {
  ...
  cc_params[cc_par_cnt++] = alloc_printf("__gfz_num_locs_defsym=%u", __gfz_num_locs + 1);
  ...
  cc_params[cc_par_cnt++] = "--defsym";
  cc_params[cc_par_cnt++] = alloc_printf("__gfz_ptr_locs_defsym=%u", __gfz_ptr_locs + 1);
  ...
  cc_params[cc_par_cnt++] = "--defsym";
  cc_params[cc_par_cnt++] = alloc_printf("__gfz_branch_locs_defsym=%u", __gfz_branch_locs + 1);
  ...
  cc_params[cc_par_cnt++] = "--defsym";
  cc_params[cc_par_cnt++] = alloc_printf("__gfz_total_bbs_defsym=%u", __gfz_total_bbs + 1);
