...
if  [[ $# -lt 1 ]] ; then
   echo "usage: $0 <gfz plot data>" >&2; exit 1
fi
...
(cat <<_EOF_
$script
set output '$1_execs.png'
plot '$1' using 1:5 with lines title 'execs' linecolor rgb '#c00080' linewidth 3, \\
     '' using 1:6 with lines title 'crashes' linecolor rgb '#c000f0' linewidth 3, \\
     '' using 1:2 with lines title 'generated' linecolor rgb '#000000' linewidth 3,
_EOF_
) | gnuplot